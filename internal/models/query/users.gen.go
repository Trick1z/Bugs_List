...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.ModifiedBy = field.NewInt64(tableName, "modified_by")
	_user.CreatedAt = field.NewTime(tableName, "created_at")
	_user.ModifiedAt = field.NewTime(tableName, "modified_at")
...
func (u *user) updateTableName(table string) *user {
	...
	u.ModifiedBy = field.NewInt64(table, "modified_by")
	u.CreatedAt = field.NewTime(table, "created_at")
	u.ModifiedAt = field.NewTime(table, "modified_at")
...
func (u *user) fillFieldMap() {
	...
	u.fieldMap["modified_at"] = u.ModifiedAt
}
