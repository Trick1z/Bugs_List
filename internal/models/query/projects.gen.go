...
func newProject(db *gorm.DB, opts ...gen.DOOption) project {
	...
	_project.ProjID = field.NewInt64(tableName, "proj_id")
	_project.ProjName = field.NewString(tableName, "proj_name")
	_project.ProjDescription = field.NewString(tableName, "proj_description")
	_project.CreatedAt = field.NewTime(tableName, "created_at")
	_project.CreateBy = field.NewInt64(tableName, "create_by")
	_project.ModifiedAt = field.NewTime(tableName, "modified_at")
	_project.ModifiedBy = field.NewInt64(tableName, "modified_by")
...
func (p *project) updateTableName(table string) *project {
	...
	p.ProjDescription = field.NewString(table, "proj_description")
	p.CreatedAt = field.NewTime(table, "created_at")
	p.CreateBy = field.NewInt64(table, "create_by")
	p.ModifiedAt = field.NewTime(table, "modified_at")
	p.ModifiedBy = field.NewInt64(table, "modified_by")
...
func (p *project) fillFieldMap() {
	...
	p.fieldMap["proj_description"] = p.ProjDescription
	p.fieldMap["created_at"] = p.CreatedAt
	p.fieldMap["create_by"] = p.CreateBy
	p.fieldMap["modified_at"] = p.ModifiedAt
	p.fieldMap["modified_by"] = p.ModifiedBy
}
